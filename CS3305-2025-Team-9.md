...
This worked in conjunction with the CameraX module to live process barcode images inside our app and on device, requiring 
...
the recipe title, ingredients, nutrients and method could be taken using their respective CSS class selector.
